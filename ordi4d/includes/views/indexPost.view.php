...
<h1 class="has-text-right">Bienvenido, <?php echo $_SESSION["nombre"]?>. | <a href="lib/logout.php"> Cerrar Sesión &nbsp</a><h1>
</section>
<!-- termina cabecera -->
<br />
...
<!--BOTÓN PARA CREAR UN NUEVO POST.
    ...
    <p class= "has-text-right"><button class="button" onclick="$('.modal').addClass('is-active');"> Crear Post</button></p>
...
<div class="card">
  ...
  <div class="card-content">
    ...
    <!--Al igual que con el título, el contenido se desplegará en el bulma card de manera acorde.-->
      ...
      <time> Fecha de publicación: <?php echo $post->created;?></time>
    </div>
  </div>
        ...
        <button value="<?php echo $post->id;?>" onclick="verificaEditar($(this).val())" class="button is-primary"> Editar </button>
            ...
            <!--BOTÓN DE ELIMINAR.
                ...
                (Ver el archivo "delete.php" para más información sobre el proceso de borrado del lado del controlador.)
                    -->
        &nbsp&nbsp<button onclick="verifica('delete.php?id=<?php echo $post->id;?>')" class="button is-danger"> Borrar </button>
  <?php
  } 
  ?>
  </footer>
